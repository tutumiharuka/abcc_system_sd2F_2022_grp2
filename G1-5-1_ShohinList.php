...
<div class="container">
            ...
            <div class="card card-body">
                ...
                <form action="G1-5-1_ShohinList.php" id="sibori" method="get">
                    <div class="row ms-0 ms-md-2">
                        ...
                        <label for="low-price" class="col-4 col-md-3 col-lg-1 text-center col-form-label">下限</label>
                        <div class="col-8 col-md-9 col-lg-2 mt-lg-0 mt-2">
                            <input type="number" class="form-control" name="lowlimit" id="low-price">
                        </div>
                        <label for="high-price" class="col-4 col-md-3 col-lg-1 text-center col-form-label">上限</label>
                        <div class="col-8 col-md-9 col-lg-2 mt-lg-0 mt-2">
    ...
    <div class="row ms-0 ms-lg-1 mb-4 justify-content-around">
        <!-- 検索結果 -->
        <div class="col-12 col-md-6 col-lg-8 mb-3 mb-md-0">検索結果：<?php echo $count?>件</div>
        ...
        <div class="row justify-content-center">
            <?php
                foreach($results as $row){
                    ...
                    echo '<div class="col-auto col-md-3">
