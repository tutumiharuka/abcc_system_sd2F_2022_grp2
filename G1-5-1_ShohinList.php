...
<?php 
    ...
    $dbmng = new DBManager();
    $results=$dbmng->getGameListByGenre($genre);
        ...
        <div class="row">
            <?php
                foreach($results as $row){
                    echo '<div class="col-md-3"><a href="G1-5-2_ShohinDetails.php?game_id='.$row['shohin_id'].'"><img class="img-thumbnail" src="'.$row['image_small'].'"><div class="card-text">'.$row['shohin_name'].'</div><h5 class="card-title">'.$row['price'].'円</h5></a></div>';
                }
