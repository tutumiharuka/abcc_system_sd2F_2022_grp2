      ...
      <div class="card ms-3" style="width: 60rem;">
        ...
        <ul class="list-group list-group-flush">
          ...
          <li class="list-group-item">
            <div class="row h5">
              <div class="col-6 col-md-3 offset-0 offset-md-3 text-start">
                <i class="bi bi-diamond-fill h6 me-3"></i>名前</div>
              <div class="col-6 col-md-6"><?php echo $name ?></div>
            </div>
          </li>
          ...
          <li class="list-group-item">
            <div class="row h5">
              ...
              <div class="col-6 col-md-6"><?php echo $mail ?></div>
            </div>
          </li>
          ...
          <li class="list-group-item">
            <div class="row h5">
              ...
              <div class="col-6 col-md-6"><?php echo $phone ?></div>
            </div>
          </li>
          ...
          <li class="list-group-item">
            <div class="row h5">
              ...
              <div class="col-6 col-md-6"><?php echo $date_of_birth ?></div>
            </div>
          </li>
